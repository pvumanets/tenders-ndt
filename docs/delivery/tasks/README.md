...
**P15:** [033](./033-no-uk-rk-keywords.md)  
...
| 033 | Без УК/РК в keywords и scoring + wipe #2 | task | doing | NEXT+ | P15 | [033-no-uk-rk-keywords.md](./033-no-uk-rk-keywords.md) |
...
- **033** — P15 без УК/РК + wipe #2 — **doing**.
