...
- **027** — P8 просрочка + архив **done**. **028** — P9 update-on-diff + Tech отчёт **done**. Дальше код **029**.
- **029** — backlog; owner lock 2026-08-26/27. Код после 028.
- **030** — покрытие поиска (сиды A–E, без лимита); **до** wipe/чистого прогона. Можно параллельно с 029.
