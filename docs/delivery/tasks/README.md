...
| 028 | Прогон: уже был + отчёт счётчиков | task | backlog | NEXT+ | | [028-run-idempotent-report.md](./028-run-idempotent-report.md) |
...
- **027** — P8 просрочка + архив **done**. Дальше код **028 → 029** по одному.
- **028–029** — backlog; owner lock 2026-08-26/27. Код **по одному**: 028 → 029.
