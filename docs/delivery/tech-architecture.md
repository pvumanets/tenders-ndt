...
- Rostender cookies протухают; ToS — [../discovery/risks-compliance.md](../discovery/risks-compliance.md). Обрезка limit 1000 — **не** канон; код [030](./tasks/030-search-coverage.md) — `limit_n=0` без must-cap.  
