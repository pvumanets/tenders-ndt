...
| Digital (владелец продукта) | **Tech** (вкладка «Прогон») | Статус прогона, cookies площадки (старт/стоп в UI — позже) |
...
2. **Tech-вкладка** — read-only статус (без Start/Stop в React).  
