...
| Named searches + очередь (NEXT+) | [discovery/named-searches.md](./discovery/named-searches.md) (`accepted`; код [023](./delivery/tasks/023-named-searches.md) / [024](./delivery/tasks/024-tender-pro-adapter.md)) |
