...
export const copy = {
  ...
  session_roseltorg_ok: "Росэлторг: cookies OK (www)",
  session_roseltorg_expired: "Росэлторг: сессия www недоступна — обновите cookies.roseltorg.txt",
  session_roseltorg_missing: "Росэлторг: нет cookies.roseltorg.txt",
  session_roseltorg: "Росэлторг: список www через cookies.roseltorg.txt",
  ...
  searches_roseltorg_docs: "Список www через cookies; файлы лота качаем при DOWNLOAD_DOCS=1",
