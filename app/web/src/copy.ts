...
export const copy = {
  ...
  session_roseltorg_ok: "Росэлторг: ELK OK (логин из .env)",
  session_roseltorg_expired: "Росэлторг: ELK недоступен — проверьте USER/PASSWORD",
  session_roseltorg_missing: "Росэлторг: нет USER/PASSWORD в .env",
  session_roseltorg: "Росэлторг: список через ELK Bearer (ROSELTORG_USER/PASSWORD)",
  ...
  searches_roseltorg_docs: "Список CORP через ELK; файлы лота в v1 не качаем",
