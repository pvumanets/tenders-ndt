...
COPY_ENV_KEYS = (
    ...
    "B2B_CENTER_USER",
    "B2B_CENTER_PASSWORD",
    "B2B_CENTER_COOKIES_FILE",
    "B2B_CENTER_BASE_URL",
    "RTS_ROSATOM_COOKIES_FILE",
    "RTS_ROSATOM_BASE_URL",
    "OILB2BCS_USER",
    "OILB2BCS_PASSWORD",
    "OILB2BCS_COOKIES_FILE",
    "OILB2BCS_BASE_URL",
    "SIBUR_COOKIES_FILE",
    "SIBUR_BASE_URL",
    "SIBUR_NWBC_NODE",
    ...
    "SMTP_RELAY_URL",
    "SMTP_RELAY_SECRET",
    "SCOUT_HTTP_RELAY_URL",
    "SCOUT_HTTP_RELAY_SECRET",
)
